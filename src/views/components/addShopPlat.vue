...
<script>
	...
	import { getPromotion, deletePromotionTargetlistStateForPlat, savePromotionRangelistBatchForPlat, sendPromotionById, queryPromotionRangelistPage,updateDelPromotionRangelist } from "@/api/shopflist";
